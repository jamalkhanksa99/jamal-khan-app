...
import '../../locationTracking/tracking.dart';

// import '../../locationTracking/trackingCode.dart';
import '../../locationTracking/trackingCustomer.dart';
import '../Freelancer/AddServiceSingleScreen.dart';
import '../Freelancer/Schedule.dart';
import '../Freelancer/categoryservices.dart';
import '../Freelancer/eservicesEdits.dart';
...
import '../modules/complaints/complaints_binding.dart';
import '../modules/complaints/complaints_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    // GetPage(name: Routes.ROOT, page: () => RootView(), binding: RootBinding()),
    GetPage(
        name: Routes.TRACKINGLOCATION,
        page: () => MapPage(),
        binding: RootBinding()),
    GetPage(
        name: Routes.TRACKINGLOCATIONCUSTOMER,
        page: () => MapPageCustomer(),
        binding: RootBinding()),
    GetPage(
        name: Routes.RATING,
        page: () => RatingView(),
    ...
    GetPage(
        name: Routes.CATEGORYSERVICES,
        page: () => CategoryServicesDetails(),
        // middlewares: [AuthMiddleware()],
        binding: CategoryBinding()),
    GetPage(
    ...
    GetPage(
        name: Routes.ADDSERVICEFREELANCER,
        page: () => AddServicesScreen(),
        binding: EServiceBinding(),
        transition: Transition.downToUp),
    GetPage(
        name: Routes.E_SERVICEFREELANCER,
        page: () => EServiceFreelancerView(),
        binding: EServiceBinding(),
        transition: Transition.downToUp),
    GetPage(
