            ...
            child: GestureDetector(
              ...
              child: Obx(() {
                if (Get.find<SettingsService>().address.value?.isUnknown() ?? true) {
                  ...
                  storage.write("addressRegister", Get.find<SettingsService>().address.value.address);
                  storage.write("addressRegisterLong", Get.find<SettingsService>().address.value.longitude);
                  storage.write("addressRegisterLat", Get.find<SettingsService>().address.value.latitude);
                }
