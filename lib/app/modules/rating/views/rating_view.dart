      ...
      body: ListView(
        ...
        children: [
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            ...
                            fit: BoxFit.cover,
                            imageUrl: controller.booking.value.eService
                                .firstImageUrl,
                        ...
                        SizedBox(height: 20),
                        Text(
                          storage.read("role") == "1" ? controller.booking.value
                              .eService.name : controller.booking.value
                              .eProvider.name,
                          style: Get.textTheme.headline6,
                          textAlign: TextAlign.center,
                        ),
                        SizedBox(height: 20),
                        storage.read("role") == "1" ?  Text(
          ...
          TextFieldWidget(
            ...
            hintText:  storage.read("role") == "1" ?"Tell us somethings about this service".tr:"...",
