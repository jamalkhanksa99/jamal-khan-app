        ...
        if (_booking.value.status.order ==
          ...
          return Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              // Text(_booking.value.status.order.toString()+"-------------"),
              // Text(Get.find<GlobalService>().global.value.done.toString()),
              // Text(_booking.value.payment.paymentStatus.id),
              // if (
              // // _booking.value.status.order ==
              // //         Get.find<GlobalService>().global.value.done &&
              //     _booking.value.payment == null)

              if (controller.booking.value.payment?.paymentStatus?.id != 2.toString())
                Expanded(
