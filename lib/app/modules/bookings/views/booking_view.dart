                        ...
                        return BookingTilWidget(
                          ...
                          actions: [
                            Container(
                              ...
                              child: Obx(() {
                                return Text(
                                  "serviceDuration".tr +controller.getTime(),
                                ...
                                if (controller.booking.value.startAt != null)
                                  BookingRowWidget(
                                      ...
                                      child: Align(
                                          alignment: Alignment.centerRight,
                                          child: Text(
                                            DateFormat('d, MMMM y - HH:mm', Get.locale.toString()).format(DateTime.parse(controller.booking.value.startAt)),
                                ...
                                if (controller.booking.value.endsAt != null)
                                  BookingRowWidget(
                                    ...
                                    child: Align(
                                        alignment: Alignment.centerRight,
                                        child: Text(
                                          DateFormat('d, MMMM y - HH:mm', Get.locale.toString()).format(DateTime.parse(controller.booking.value.endsAt)),
                            ...
                            children: [
                              ...
                              if (controller.booking.value.eService.priceUnit == 'fixed')
                                BookingRowWidget(
                                    ...
                                    child: Align(
                                      alignment: Alignment.centerRight,
                                      child: Text(
                                        "x" + controller.booking.value.quantity.toString()
                              ...
                              Obx(() {
                                return BookingRowWidget(
                                  ...
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Ui.getPrice(controller.booking.value.getTaxesValue(),
                              ...
                              Obx(() {
                                return BookingRowWidget(
                                    ...
                                    child: Align(
                                      alignment: Alignment.centerRight,
                                      child: Ui.getPrice(controller.booking.value.getSubtotal(),
                                          style: Get.textTheme.subtitle2),
                                    ),
                                    hasDivider: true);
                              }),
                                      ...
                                      child: Wrap(
                                        children: [
                                          ...
                                          Ui.getPrice(controller.booking.value.coupon.discount,
                                              style: Get.textTheme.bodyText1,
                                              unit: controller.booking.value.coupon.discountType == 'percent'
                                                  ? "%" : null),
                                        ],
                                      ),
                                    ),
