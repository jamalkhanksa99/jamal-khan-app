...
class BookingController extends GetxController {
  ...
  Future<void> getBooking() async {
    try {
      ...
      if (booking.value.status ==
          Get.find<BookingsController>().getStatusByOrder(3
  ...
  Future<void> startBookingService() async {
    try {
      ...
      final _booking = new Booking(id: booking.value.id, startAt: "", status: _status);
      // /changed
  ...
  Future<void> finishBookingService() async {
    try {
      ...
      var _booking = new Booking(id: booking.value.id, endsAt: "", status: _status);
