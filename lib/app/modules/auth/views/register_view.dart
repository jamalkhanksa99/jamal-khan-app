                ...
                if (controller.loading.isTrue) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      storage.read("roleRegister") == '2'
                          ? TextFieldWidget(
                              labelText: "TaxNumber".tr,
                              hintText: "••••••••••••".tr,
                              keyboardType: TextInputType.number,
                              initialValue:
                                  controller.currentUser?.value?.taxNumber,
                              onSaved: (input) => controller
                                  .currentUser.value.taxNumber = input,
                              validator: (input) =>
                                  input == null ? "Required".tr : null,
                              // iconData: Icons.tv,
                              isFirst: false,
                              isLast: false,
                            )
                          : Container(),
                      storage.read("roleRegister") != '1'
                          ? AddressWidget()
                          : Container(),
                      storage.read("roleRegister") != '1'
                          ? TextFieldWidget(
                              labelText: "AvailabilityRange".tr,
                              hintText: "--".tr,
                              suffix: Text("Km".tr),
                              keyboardType: TextInputType.number,
                              initialValue: controller
                                  .currentUser.value.availabilityRange,
                              onSaved: (input) => controller
                                  .currentUser.value.availabilityRange = input,
              ...
              children: [
                SizedBox(
                  ...
                  child: BlockButtonWidget(
                    onPressed: () {
                      if(controller.acceptTerms.isTrue)
                      controller.register();

                      else Get.showSnackbar(
                          Ui.defaultSnackBar(
                              title:"Alert".tr,
                              message: "please accept terms".tr
                          )
                      );
