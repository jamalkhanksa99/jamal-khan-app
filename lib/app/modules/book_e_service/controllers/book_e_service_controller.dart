...
class BookEServiceController extends GetxController {
  ...
  void getTimeSlots(String day, String serviceId) async {
    try {
      var slots = await _bookingRepository.timeSlots(day, serviceId);
      timeSlots = slots.obs;
      booking.update((val) {
