...
class EService extends Model {
  ...
  EService.fromJson(Map<String, dynamic> json) {
    try {
      capacity = int.parse(stringFromJson(json, 'capacity'));
    } catch (e) {}

    try {
      inHome = int.parse(stringFromJson(json, 'in_home'));
    } catch (e) {}

    try {
      inCenter = int.parse(stringFromJson(json, 'in_center'));
    } catch (e) {}
  ...
  Map<String, dynamic> toJson() {
    ...
    //important
    if (uuid != null) data['image'] = this.uuid;
    //testing
