...
class Booking extends Model {
  ...
  Booking.fromJson(Map<String, dynamic> json) {
    ...
    try {
      type = intFromJson(json, 'booking_type');
    } catch (e) {}
    ...
    if(storage.read("role")!="1" && storage.read("role")!=null)
    eProvider =
        objectFromJson(json, 'user', (v) => EProvider.fromJson(v)); else   eProvider =
    ...
    startAt = stringFromJson(json, 'start_at', defaultValue: null);
    endsAt = stringFromJson(json, 'ends_at', defaultValue: null);
  }
