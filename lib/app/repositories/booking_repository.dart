...
class BookingRepository {
  ...
  Future<List<Map<String, dynamic>>> timeSlots(String day,String id) {
    return _laravelApiClient.getTimeSlots(day, id);
  }

  Future<Review> addReview(Review review, String order_id) {
    return _laravelApiClient.addReview(review , order_id);
  }
}
