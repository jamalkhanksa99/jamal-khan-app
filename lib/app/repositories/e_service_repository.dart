...
class EServiceRepository {
  ...
  Future<List<EService>> getAllWithPaginationFiltered(String categoryId,  String type) {

    return _laravelApiClient.getAllEServicesFiltered(categoryId, type);
  }
  ...
  Future<bool> deleteEservice(EService eService) {
    return _laravelApiClient.removeEService(eService.id);
  }
  ...
  // added by mariam
  Future<EService> add(EService eService, String categoryId, int inHome, int inCenter, Media uuid) {
    return _laravelApiClient.addEService(eService, categoryId, inHome, inCenter, uuid);
  }

  // added by mariam
  Future<EService> edit(EService eService, String categoryId, Media image) {
    return _laravelApiClient.editEService(eService, categoryId, image);
  }
